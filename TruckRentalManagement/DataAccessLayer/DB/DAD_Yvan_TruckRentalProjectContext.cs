...
{
    public partial class DAD_Yvan_TruckRentalProjectContext : DbContext
    {
        public DAD_Yvan_TruckRentalProjectContext()
        {
        }

        public DAD_Yvan_TruckRentalProjectContext(DbContextOptions<DAD_Yvan_TruckRentalProjectContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=citizen.manukautech.info,6302;Initial Catalog=DAD_Yvan_TruckRentalProject;Persist Security Info=True;User ID=DAD_YvanLawrenze;Password=fBit$42222;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=True;Connection Timeout=30;");
            }
        }
